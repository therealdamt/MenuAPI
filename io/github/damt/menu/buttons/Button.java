...
public class Button implements Cloneable {
    ...
    /**
     * Sets the custom model data of the stack
     * CAN BE REMOVED IF UNDER 1.13!
     *
     * @param data for the custom model data to be set as
     * @return {@link Button}
     */

    public Button setCustomModelData(int data) {
    ...
    public ItemStack toItemStack() {
        ...
        if (meta != null) { // it can STILL be null, some items don't have an item meta.
            ...
            meta.setCustomModelData(customMetaData);
